...
class MyAppWidgetProvider2_2 : AppWidgetProvider() {
  ...
  //          remoteViews.setViewPadding(R.id.rootParent, R.dimen.dp_15.dmToPx(), 0, R.dimen.dp_15.dmToPx(), 0)
            val name = ComponentName(context, MyAppWidgetProvider2_2::class.java)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_APPWIDGET_UPDATE) {
            UpdateTask.widgetUpdateDataUtil2_2.updateWidget("ck2")
        }
    }
