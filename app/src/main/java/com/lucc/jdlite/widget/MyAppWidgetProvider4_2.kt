...
class MyAppWidgetProvider4_2 : AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
     ...
     //       remoteViews.setViewPadding(R.id.rootParent, R.dimen.dp_15.dmToPx(), 0, R.dimen.dp_15.dmToPx(), 0)
            val name = ComponentName(context, MyAppWidgetProvider4_2::class.java)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_APPWIDGET_UPDATE) {
            UpdateTask.widgetUpdateDataUtil4_2.updateWidget("ck4")
        }
    }
